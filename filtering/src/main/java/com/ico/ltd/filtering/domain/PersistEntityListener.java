 ...
 * It doesn’t have to implement any special interfaces. An entity listener is stateless;
 * the JPA engine automatically creates and destroys it.
 */
public class PersistEntityListener {
     ...
     */
    @PostPersist
    private void notifyAdmin(Object entityInstance) {
        /*
